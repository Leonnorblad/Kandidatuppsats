...
# ________________________________________________________________________________________________
# 3. Enkel beskrivande statistik (tabell 2.1-2.2)
# ________________________________________________________________________________________________
# 4. Stapeldiagram
# - 4.1 Stapeldiagram över totala antalet ärenden för repsektive driftområde (Figur 2.3)
...
# - 5.2 Totala antalet ärenden uppdelat på driftområde med andel (tabell 2.4)
# ________________________________________________________________________________________________
...
# - 7.2 Andelen 0:or uppdelat på driftområde (tabell 2.5)
# ________________________________________________________________________________________________
...
# Antalet unika driftområden (9 st). Tabell 2.1
unique(data$Driftområde)

# Antalet unika kategorier (11 st). Tabell 2.2
unique(data$Kategori)

# Antalet unika anmälda serviceärenden = 74 206 st
nrow(data)
...
# Ordnar tabell
T1 <- T1[order(T1$andel_0or, decreasing = TRUE),]
T2_5 <- data.frame(T1$Driftområde,
                   T1$andel_0or)
T2_5 <- T2_5[,-2]
colnames(T2_5) <- c("Driftområde", "Andel dagar utan ärenden")
